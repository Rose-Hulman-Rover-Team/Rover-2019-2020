...
if("TRUE" STREQUAL "TRUE")
  set(ydlidar_SOURCE_PREFIX /home/chenz16/Desktop/Rover/src/ydlidar)
  set(ydlidar_DEVEL_PREFIX /home/chenz16/Desktop/Rover/devel_isolated/ydlidar)
  set(ydlidar_INSTALL_PREFIX "")
  set(ydlidar_PREFIX ${ydlidar_DEVEL_PREFIX})
else()
  set(ydlidar_SOURCE_PREFIX "")
  set(ydlidar_DEVEL_PREFIX "")
  set(ydlidar_INSTALL_PREFIX /home/chenz16/Desktop/Rover/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ydlidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chenz16/Desktop/Rover/src/ydlidar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chenz16/Desktop/Rover/devel_isolated/ydlidar/lib;/home/chenz16/Desktop/Rover/devel/lib;/home/chenz16/Desktop/Rover/install_isolated/lib;/opt/ros/kinetic/lib)
